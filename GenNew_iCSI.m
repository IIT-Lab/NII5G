function [ChnNew] = GenNew_iCSI(Num_Cell, S, Num_User, Num_TxAnt_Macro,Num_TxAnt_Pico,Num_Rx_Ant,path_loss_dB,Chn,sigma)
...
iCSI = randn(Num_Cell,Num_BS,Num_TxAnt_Macro,Num_Cell,Num_User,Num_Rx_Ant) * sigma ;
                    ...
                    if n == 1 %Macro BS
                        ...
                        for p=1:Num_TxAnt_Macro
                            for q=1:Num_Rx_Ant
                                ...
                                %%% Imperfect CSI is Added 
                                %%%-------------------------------------
                                
                                fd = Chn(l,n,p,m,k,q)/PL;
                                ChnNew(l,n,p,m,k,q) = PL * (fd + iCSI(l,n,p,m,k,q));
